...
export default function SignUp() {
  ...
  const handleSubmit = (event) => {
    ...
    if(!aceito) {
      toast.error("Você precisa aceitar os termos e condições para se cadastrar", {
      ...
      return
    } else if (data.get("senha") === "" || data.get("senha2") === "" || data.get("email") === "" || data.get("firstName") === "") {
      ...
      return
    } else if (data.get("senha") !== data.get("senha2")) {
    ...
    axios
      .post(`http://${ip}/registrar`, {
        usuario: data.get("firstName"),
      ...
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          >
            ...
            <FormControl variant="outlined" sx={{ width: '100%' }} maxWidth={false}>
              <InputLabel htmlFor="senha" required>Repita a senha</InputLabel>
              <OutlinedInput
                id="senha2"
                name="senha2"
              ...
              <Grid item xs={12}>
              <label for="termoscondicoes" style={{textAlign: "center"}}><ModalTermos aceito={aceito} setAceito={setAceito}/></label>
              </Grid>
            </Grid>
            <Button
              type="submit"
